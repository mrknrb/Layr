(function e(t, n, r) { function s(o, u) { if (!n[o]) {
    ...
    s(r[o]); return s; })({ 1: [function (_dereq_, module, exports) {
            ...
            if (!(HAS_INSTANCE in FunctionProto))
                _dereq_(72).f(FunctionProto, HAS_INSTANCE, { value: function (O) {
            ...
            $export($export.P + $export.F * (!!$toFixed && (0.00008.toFixed(3) !== '0.000' ||
                ...
                1000000000000000128.0.toFixed(0) !== '1000000000000000128') || !_dereq_(35)(function () {
                // V8 ~ Android 4.3-
                $toFixed.call({});
            })), 'Number', {
                    ...
                    function AsyncIterator(generator) {
                        ...
                        function enqueue(method, arg) {
                            ...
                            return previousPromise =
                                ...
                                // call invoke immediately, without waiting on a promise to fire,
                                // so that the async generator function has the opportunity to do
                                // any necessary setup in a predictable way. This predictability
                                // is why the Promise constructor synchronously invokes its
                                // executor promise, and why async functions synchronously
